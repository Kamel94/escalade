...
public class EscaladeApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		/*topoRepository.save(new Topo("Gorges du Todgha", "Vous trouverez dans les gorges du Todgha de nombreux secteurs de couennes de tous les niveaux (4b à 8c), des grandes voies équipées (jusqu'à 350m) et des parcours de ...", "Maroc", 2020/03/19, "Disponible"));
